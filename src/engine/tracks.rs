...
use crate::tracks::SpaceOccupant::KansasCity;

#[derive(Copy, Clone)]
pub enum SpaceOccupant<'a> {
    Building(And<Action<'a>, 3>, Option<Building<'a>>),
...
#[derive(Copy, Clone)]
pub struct Space<'a> {
    occupant: SpaceOccupant<'a>,
    nextSpace: [Option<usize>; 2],
}

impl<'a> Space<'a> {
    pub fn new(occupant: SpaceOccupant<'a>, nextSpace: [Option<usize>; 2]) -> Space<'a> {
        return Space { occupant, nextSpace };
    }
}

pub fn defaultTrack() -> Vec<Space<'static>> {
     let v = 5 / 0;
    // 51 space track
    vec![Space::new(SpaceOccupant::Start, [Some(1), None]),                                         //  0
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(2), Some(5)]),               //  1 A
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(10), None]),                 //  9   Special 1
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(11), None]),                 // 10   Special 1
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(12), Some(15)]),             // 11 B
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(20), None]),                 // 19   Special 2
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(21), Some(23)]),             // 20 C
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(33), None]),                 // 24 D
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(32), None]),                 // 31   Special 2
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(33), None]),                 // 32   Special 1
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(34), Some(36)]),             // 33 E
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(41), None]),                 // 40   Special 2
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(42), None]),                 // 41   Special 1
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(43), Some(44)]),             // 42 F
         ...
         Space::new(SpaceOccupant::Building(And::empty(), None), [Some(46), Some(47)]),             // 45 G
